...
\033[1;32;40m      [+] TOOL BY SHASHIMAL - THIRD EYE TEAM LEADER
\033[1;33;40m    [~] TOOL MOD BY PRABOD SARANGA - HACKERS EYE TEAM                         
...
def main():
    ...
    while True:
        ...
        if resp == '<Response [204]>':
            print(bar)
            print("\n\033[1;35;40m [+] ＮＯ ＤＡＴＡ ... [+]","\n\033[1;36;40m [+]...ＰＲＡＢＯＤ ＳＡＲＡＮＧＡ...[+]")
            print(bar)
        elif resp == '<Response [200]>':
            print(bar)
            print("\n\033[1;33;40m [*] ＷＯＮ ＤＡＴＡ ... [*]","\n\033[1;36;40m [+]...ＰＲＡＢＯＤ ＳＡＲＡＮＧＡ...[+]")
            print(bar)
        else:
            print(bar)
            print("\n\033[1;31;40m [~] ＮＯ ＳＩＧＮＡＬ ... [~]","\n\033[1;36;40m [+]...ＰＲＡＢＯＤ ＳＡＲＡＮＧＡ...[+]")
            print(bar)

        ss+=1
        print("\033[1;36;40m\n",str(ss), "Ｗａｉｔ 100 Ｓｅｃｏｎｄｓ Ｆｏｒ Ｍａｓｓａｇｅ","\n\033[1;33;40m...💯ＰＲＡＢＯＤ ＳＡＲＡＮＧＡ💯...",end="")
        for i in range(180):
